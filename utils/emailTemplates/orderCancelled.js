const orderCancelledTemplate = (products, totalPrice) => {
  return `
  <mjml>
          <mj-body>
              <mj-section>
              <mj-column>
                  ...
                  <mj-text font-size="12px" color="#F45E43" font-family="helvetica">An order has been cancelled. Here's a summary of the cancelled order:</mj-text>
